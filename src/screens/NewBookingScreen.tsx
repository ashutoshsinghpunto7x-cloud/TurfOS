...
const dc = StyleSheet.create({
  wrap:   { flex: 1 },
  card:   {
    paddingVertical: 10, borderRadius: 18, backgroundColor: T.surface,
    alignItems: 'center', gap: 2, borderWidth: 1, borderColor: T.border,
    shadowColor: 'rgba(0,0,0,0.07)', shadowOffset: { width: 0, height: 4 },
...
function GlassCard({ children, style }: { children: React.ReactNode; style?: object }) {
  return (
    <View style={[{
      backgroundColor: T.glass, borderRadius: 24,
      borderWidth: 1, borderColor: 'rgba(255,255,255,0.85)',
      shadowColor: T.grad0, shadowOffset: { width: 0, height: 8 },
          ...
          >
            ...
            <Animated.View style={{
              ...
              <View style={s.dateStrip}>
                {days.map((d, i) => (
                  <DateCard
                    key={toISO(d)} date={d} label={fmtDow(d, i)}
...
const s = StyleSheet.create({
  ...
  header:     {
    ...
    paddingTop: 6, paddingBottom: 14, borderBottomWidth: 1, borderBottomColor: T.border,
  ...
  durPill:   {
    paddingHorizontal: 16, paddingVertical: 9, borderRadius: 50, backgroundColor: T.surface,
    borderWidth: 1.5, borderColor: T.border,
    shadowColor: 'rgba(0,0,0,0.05)', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 1, shadowRadius: 6, elevation: 2,
  },
